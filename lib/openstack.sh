...
show_help_add() {
    ...
    echo "./lib/openstack.sh add-image --task debian-12-64 [--image-url <URL>] --target-image debian-12-64-base-v$(date +'%Y%m%d')"
    ...
    echo "./lib/openstack.sh add-image --task opensuse-15.5-64 [--image-url <URL>] --target-image opensuse-15.5-64-base-v$(date +'%Y%m%d')"
    echo "./lib/openstack.sh add-image --task opensuse-15.6-64 [--image-url <URL>] --target-image opensuse-15.6-64-base-v$(date +'%Y%m%d')"
}
