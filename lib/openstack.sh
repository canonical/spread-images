...
show_help_add() {
    ...
    echo "  openstack"
    echo "  openstack-ps7"
    echo "  openstack-arm-ps7"
    echo "  openstack-stg-ps7"
    echo "  openstack-stg-arm-ps7"
    echo ""
    echo "examples:"
...
show_help_update() {
    ...
    echo "./lib/openstack.sh update-image --backend openstack-ps7 --task ubuntu-25.10-64 --source-system ubuntu-25.10-64-base --target-system ubuntu-25.10-64"
    echo "./lib/openstack.sh update-image --backend openstack-ps7 --task ubuntu-26.04-64 --source-system ubuntu-26.04-64-base --target-system ubuntu-26.04-64"
    echo ""
    ...
    echo "./lib/openstack.sh update-image --backend openstack-ps7 --task ubuntu-26.04-64 --source-system ubuntu-26.04-64-base --target-system ubuntu-26.04-64-uefi --property hw_firmware_type=uefi"
    echo ""
    ...
    echo "./lib/openstack.sh update-image --backend openstack-arm-ps7 --task ubuntu-26.04-arm-64 --source-system ubuntu-26.04-arm-64-base --target-system ubuntu-26.04-arm-64"
    echo ""
    ...
    echo "./lib/openstack.sh update-image --backend openstack-arm-ps7 --task ubuntu-26.04-arm-64 --source-system ubuntu-26.04-arm-64-base --target-system ubuntu-26.04-arm-64-uefi --property hw_firmware_type=uefi"
    echo ""
