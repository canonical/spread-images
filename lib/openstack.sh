...
show_help_add() {
    ...
    echo ""
    echo "examples:"
    echo "./lib/openstack.sh add-image --backend openstack-ps7 --task amazon-linux-2-64 --target-system amazon-linux-2-64-base"
...
show_help_update() {
    ...
    echo ""
    echo "examples:"
    echo "./lib/openstack.sh update-image --backend openstack-ext-ps7 --task amazon-linux-2-64 --source-system amazon-linux-2-64-base --target-system amazon-linux-2-64"
