...
show_help_add() {
    ...
    echo ""
    echo "examples:"
    echo "./lib/openstack.sh add-image --backend openstack --task amazon-linux-2-64 --target-system amazon-linux-2-64-base --property os_secure_boot=required"
    ...
    echo "./lib/openstack.sh add-image --backend openstack --task fedora-41-64 --target-system fedora-41-64-base"
    echo "./lib/openstack.sh add-image --backend openstack --task fedora-42-64 --target-system fedora-42-64-base --property os_secure_boot=required"
...
show_help_update() {
    ...
    echo ""
    echo "examples:"
    echo "./lib/openstack.sh update-image --backend openstack --task amazon-linux-2-64 --source-system amazon-linux-2-64-base --target-system amazon-linux-2-64 --property os_secure_boot=required"
    ...
    echo "./lib/openstack.sh update-image --backend openstack --task fedora-41-64 --source-system fedora-41-64-base --target-system fedora-41-64"
    echo "./lib/openstack.sh update-image --backend openstack --task fedora-42-64 --source-system fedora-42-64-base --target-system fedora-42-64 --property os_secure_boot=required"
